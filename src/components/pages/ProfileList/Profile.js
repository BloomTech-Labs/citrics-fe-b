...
function UserProfile(props) {
  const { item } = props
  return (
      <div class="body" style={{ display: "flex", justifyContent: "space-evenly", flexWrap: "wrap"}}>
      <div className="card" style={{ width: "30%", backgroundColor: '#05386B', alignItems: "center", color: "#EDF4E1", fontFamily: "Tajawal, sans-serif", marginTop: "5%"}}>
        <CardImg  src="https://images.unsplash.com/photo-1431887915357-68b819fae322?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjF9" top width="100%" alt= "Username"/>
        <CardBody>
